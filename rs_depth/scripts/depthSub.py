...
class DepthSubscriber(object):
    def __init__(self):
        ...
        self.cy = -50 + self.depth_height/2
    ...
    def getCorners(self):
        ...
        """
        corners = []
        corners.append(25) # Left width i.e -20 to +20 around center
        corners.append(int(self.cy - (self.height_dim/2))) 
        corners.append(int(self.cx - (self.width_dim/2)))
        corners.append(int(self.cy - (self.height_dim/2)))
        corners.append(int(self.depth_width - self.width_dim - 20-0))
        corners.append(int(self.cy - (self.height_dim/2)))
        return corners
    ...
    def getDepth(self, depthImage, width, height, corners, indices):
        ...
        #if(indices[0]==4):
        #print("Counter",counter, indices, corners)
    ...
    def depth_callback(self, data):
        ...
        depthInfo = Float32MultiArray(data=[depth_left, depth_center, depth_right])
