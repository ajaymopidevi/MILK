...
turn_depth = rospy.get_param('/master_state_machine/turn_depth', 1000)
...
class Polulu_Command:
    ...
    def send_command(self, jntName, pos, speed=0):
        print("Pololu",jntName, pos, speed)
...
if __name__ =='__main__':
    ...
    while not rospy.is_shutdown():
        ...
        ss.determine_state()
        #print(ss.curr_turn, ss.turn_state_flag, ss.start_flag, ss.is_in_turn)
